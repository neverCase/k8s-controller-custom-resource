module github.com/nevercase/k8s-controller-custom-resource

go 1.17

require (
	github.com/Shanghai-Lunara/helixsaga-operator v0.0.0-20211231035827-a6e86fe581b9
...
require (
	...
	github.com/casbin/casbin/v2 v2.26.0 // indirect
	github.com/casbin/gorm-adapter/v3 v3.2.6 // indirect
